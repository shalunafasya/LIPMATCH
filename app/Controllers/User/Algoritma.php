...
class Algoritma extends Controller
{
    ...
    {
        parent::__construct();
        // Memuat model dengan cara yang benar
        $this->BencanaModel = new BencanaModel();  // Pastikan namespace sesuai
        $this->RelawanModel = new RelawanModel();  // Pastikan namespace sesuai
    }
