            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="card shadow mb-4">
                        <div class="row">
    <div class="col">
        <form method="POST" action="<?= site_url('admin/Jenis_lipstik/proses_edit_data/' .$data_jenis_lipstik['id_jl']);  ?>">
        <div class="form-group row mt-3 mr-2 ml-2">
            <label for="jenis_lipstik" class="col-sm-3 col-form-label">Jenis Lipstik</label>
            <div class="col-sm-9">
                <input type="text" class="form-control" id="jenis_lipstik" name="jenis_lipstik" value="<?= $data_jenis_lipstik['jenis_lipstik'] ?>">
            </div>
        </div>
