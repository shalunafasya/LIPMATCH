        ...
        <div class="container-fluid">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    ...
                    <a href="<?= base_url('admin/Jenis_lipstik/tambah_dataJL') ?>"
                            ...
                            <tbody>
                                ...
                                <?php foreach ($List_JL as $JL): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?= base_url() ?>admin/Jenis_lipstik/editdata/<?= $JL['id_jl'] ?>"><button
                                                    type="button" class="btn btn-success btn-icon-text">Edit</button></a>
                                            <a href="<?= base_url() ?>admin/Jenis_lipstik/hapusdata/<?= $JL['id_jl'] ?>"><button
