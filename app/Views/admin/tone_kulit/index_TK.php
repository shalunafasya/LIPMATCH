...
<!-- Content Wrapper -->
        ...
        <div class="card-header py-3">
            ...
            <a href="<?= base_url('admin/Tone_Kulit/tambah_data') ?>" class="btn btn-success mr-1 font-weight-bold"><i class="fas  fa-print"></i> Tambah Data</a>
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <?php foreach($List_TK as $TK):?>
                            ...
                            <td><?= $TK['tone_kulit'] ?></td>
                            <td>
                                <a href="<?= base_url()?>admin/Tone_Kulit/editdata/<?= $TK['id_tk'] ?>"><button type="button" class="btn btn-success btn-icon-text">Edit</button></a>
                                <a href="<?= base_url()?>admin/Tone_Kulit/hapusdata/<?= $TK['id_tk'] ?>"><button type="button" class="btn btn-danger btn-icon-text">Hapus</button></a>
                            </td>
                            </tr>
                            <?php $i++; ?>
                        <?php endforeach ?>
