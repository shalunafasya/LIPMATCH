            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="card shadow mb-4">
                        <div class="row">
    <div class="col">
        <form method="POST" action="<?= site_url('admin/Kriteria/proses_edit_data/' .$data_kriteria['id_kriteria']);  ?>">
        <div class="form-group row mt-3 mr-2 ml-2">
            <label for="kriteria" class="col-sm-3 col-form-label">Kriteria</label>
            <div class="col-sm-9">
                <input type="text" class="form-control" id="kriteria" name="kriteria" value="<?= $data_kriteria['kriteria'] ?>">
            </div>
        </div>
