    ...
    <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
            <div class="container-fluid">
                <span class="navbar-brand mb-0 h1" style="color: #EA84B4">Dashboard Kelola Data Kriteria</span>
            </div>
        </nav>
        ...
        <div class="container-fluid">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    ...
                    <a href="<?= base_url('admin/Kriteria/tambah_data') ?>"
                            ...
                            <tbody>
                                ...
                                <?php foreach ($List_Kriteria as $kriteria): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a
                                                href="<?= base_url() ?>admin/Kriteria/editdata/<?= $kriteria['id_kriteria'] ?>"><button
                                                    type="button" class="btn btn-success btn-icon-text">Edit</button></a>
                                            <a
                                                href="<?= base_url() ?>admin/Kriteria/hapusdata/<?= $kriteria['id_kriteria'] ?>"><button
