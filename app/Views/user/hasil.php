...
<div id="content">
    ...
    <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-">
            <h1 class="h6 mb-0 text-primary" style="font-family: 'Poppins', sans-serif; font-size: 26px; font-weight: 600; letter-spacing: 1px;">LIPMATCH</h1>
        </div>
...
<div class="container">
    <div class="card rounded-lg mt-5 mb-5">
        <div class="card-body">
            <div class="table-responsive float-right">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    <h1 class="text-uppercase"><?= session('sess_lipstik_nama') ? 'Hi.. '.session('sess_lipstik_nama') : ''; ?>
                    </h1>
                    <h1 class="h6 ml-1 mb-3 text-gray-800">hasil skor kondisi bibir anda sebagai berikut :</h1>
                    <thead>
        ...
        <h1 class="h6 ml-5 mb-3 text-danger font-italic">*catatan : untuk hasil yang lebih jelas, anda bisa melakukan konsultasi langsung dengan ahli </h1>
        <div class="container">
            <div class="row my-4">
                <div class="col-6">
            ...
            <div class="row my-4">
                <?php foreach($list_produk as $list): ?>
                    <div class="col-3 mb-2">
                        <div class="card">
                            <img class="card-img-top" src="<?= base_url("/assets/image/produk/" . $list->gambar) ?>">
      ...
      <form action="<?= base_url('User/Jenis_Bibir/rekomendasi') ?>" method="post">
          <div class="modal-body">
            ...
            <?php foreach($filters as $filter): ?>
                <input type="checkbox" class="list_filter" id="id-<?= $filter['id_jl'] ?>" onclick="checkFilterCondition(this)" name="filter_produk[]" value="<?= $filter['id_jl'] ?>" checked>
                &nbsp; &nbsp; <label for="id-<?= $filter['id_jl'] ?>"><?= $filter['jenis_lipstik'] ?></label>
                <br>
            <?php endforeach; ?>
          </div>
